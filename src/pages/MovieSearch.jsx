...
const MovieSearch = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#0F1016] font-roboto transition-all duration-200">
      <div className="max-w-7xl mx-auto flex flex-col pt-24 gap-6">
...
const MovieSearchBar = ({ search, setSearch }) => {
  return (
    <div className="">
      <div className="w-full h-auto bg-black/80 mx-auto px-5 py-3 relative rounded-2xl">
        <Search
          className="text-white absolute left-0 top-7 font-bold mx-4"
          size={20}
        />
        <Input
          placeholder="Movies, Shows and More"
          classname="w-full border-0 text-xl ml-2 text-white/80"
          value={search}
